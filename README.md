...
- **추가 학습 필요:** JDBC, MySQL 연동, ORM 개념 적용 가능성 검토
...
- **추가 학습 필요:** 파일 입출력 (데이터 저장), JSON/XML 처리 방식 고려
...
- **추가 학습 필요:** UI 프레임워크 활용 가능성 검토 (JavaFX, Swing 등)
...
| **2025-03-07** | 추상화 & 인터페이스 개념 학습, 예외처리 & 예외던지기 개념 정리, 익명클래스 개념 학습 |
