 ...
 * Generated at: 2025-03-31 00:05:20 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/standard.jar", Long.valueOf(1743143972041L));
    _jspx_dependants.put("jar:file:/D:/Java_2025/tomcat9.0/apache-tomcat-9.0.100/wtpwebapps/Ynbookstore/WEB-INF/lib/standard.jar!/META-INF/c.tld", Long.valueOf(1090214156000L));
    _jspx_dependants.put("/inc/header.jsp", Long.valueOf(1743149237625L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	        	 console.log(items[0]); //객체한개 = {title:\"\",image:\"\"}\r\n");
      out.write("	        	 \r\n");
      out.write("	        	 for(let i=0; i<items.length; i++){\r\n");
      out.write("	        		 let div = $('<div class=\"card my-3\">'); //<div></div> 태그만들기\r\n");
      out.write("	        		 let p1 = $('<div class=\"card-body\">').html('<img src=\"'+items[i].image+'\"style=\"width: 200px; height: auto;\"/>');\r\n");
      out.write("	        		 let p2 = $('<div class=\"card-body\" >').html(items[i].title); //html reset해서 넣기\r\n");
      out.write("	        		 let p25 = $('<div class=\"card-body\" >').html('브랜드 : '+items[i].brand);\r\n");
      out.write("	        		 let p3 = $('<div class=\"card-body\">').html('<a href=\"'+items[i].link+'\"/>'+items[i].title+'</a>'); \r\n");
      out.write("	        		 let p35 = $('<div class=\"card-body\">').html('필터 : '+items[i].category2);\r\n");
      out.write("	        		 let p4 = $('<div class=\"card-body\">').html(items[i].lprice+'원');\r\n");
      out.write("	        		 \r\n");
      out.write("	        		 div.append(p1).append(p2).append(p25).append(p3).append(p35).append(p4); //div태그안에 p1추가하고 p2추가\r\n");
      out.write("	        		 $(\".result\").append(div);\r\n");
      out.write("	        	 }\r\n");
      out.write("	        	 //2. 보여줄 화면에 껴넣기\r\n");
      out.write("	        	 \r\n");
      out.write("	        	 \r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /board/list.jsp(62,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /board/list.jsp(62,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("dto");
    // /board/list.jsp(62,4) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
